...
from modules.mixers.thgc import THGCMixer
import torch as th
from torch.optim import RMSprop

#  Main CONTROLLER FOR learning .. ONLY MODELS IMPORTING HERE, No new model formed

'''
Define structure in the thgc agents but mixing inputs part (IN GAT)
can be done here for easy solving.
'''


# mac - is just the info of map...
class THGCLearner:
